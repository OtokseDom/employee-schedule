...
import { ArrowLeftFromLine, ArrowLeftToLine, MenuIcon, MoveLeft, PanelLeft, X } from "lucide-react";
...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
	...
	return (
		<Button
			...
			variant="ghost"
			// size="icon"
			className={cn("mt-2 z-20 transition-all duration-300 ease-in-out", className)}
			onClick={(event) => {
				onClick?.(event);
				toggleSidebar();
			}}
...
const SidebarSeparator = React.forwardRef(({ className, ...props }, ref) => {
	return <Separator ref={ref} data-sidebar="separator" className={cn("mx-2 w-auto bg-background-border", className)} {...props} />;
});
